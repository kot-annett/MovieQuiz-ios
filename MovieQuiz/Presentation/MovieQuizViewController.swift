...
/*
 Solution 2 (без вью модели и метода конвертации)
 ...
 // приватный метод, показывающий вопрос
 private func showQuestion(at index: Int) {
     //if index >= 0 && index < questions.count {
         let question = questions[index]
         imageView.image = UIImage(named: question.image) ?? UIImage()
 ...
 // приватный метод перезапуска квиза, который заново показывает первый вопрос
